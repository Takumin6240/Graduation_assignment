...
問題を解きながら、少しずつ理解していきましょう!', 1)
    ...
    const problems = [
      ...
      },
      {
        ...
        description: '階段を登るプログラムを作りましょう!\n「右に10歩 → 上に10歩」の動きを3回繰り返して、階段を登ります。\n\n今回は繰り返しブロックを使わず、6個の命令を順番に並べてください。\n順次処理でも、同じ命令を何度も並べれば繰り返しを表現できます。\n\nヒント: 右 → 上 → 右 → 上 → 右 → 上 の順番です。',
        difficulty: 4,
        order: 4,
        initial_sb3_data: {
          targets: [{
